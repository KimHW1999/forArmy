...
- 설명: 군사특기별 제출 대상 서류 안내. 문서 설명상 응시지방병무청에서 필요 시 제출 방법과 기한을 개별 안내할 수 있으므로, 화면에서는 전원 필수 서류가 아니라 제출 대상/해당자 증빙 목록으로 안내한다.
...
- 정규화 기준:
  ...
  - `psjechulYn === "Y"`이면 제출 대상 서류로 분류한다. 다자녀, 국가유공자, 헌혈, 봉사활동 등 해당자 증빙 서류가 포함될 수 있어 전원 필수로 해석하지 않는다.
